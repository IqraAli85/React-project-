...
//  <a href="/Plan your Journey" class="mr-7">Plan Your Journey</a>
...
// //  <NavDropdown title="Routes" id="navbarScrollingDropdown">
// //   <NavDropdown.Item href="/Bus1">FR1</NavDropdown.Item>
// //   <NavDropdown.Item href="/Bus2">FR2</NavDropdown.Item>
// //   <NavDropdown.Item href="/Bus3">FR3</NavDropdown.Item>
...
// // </div>
// // <div>
// //   <button onClick={() => setMobileMenu(!mobileMenu)} type="button" className="lg:hidden bg-black text-white rounded-3xl w-full py-4 text-center uppercase text-sm shadow-2xl lg:shadow-none focus:outline-none">
// //     <template x-if="!mobileMenu">
// //       <div className="flex items-center justify-center">
// //         <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
