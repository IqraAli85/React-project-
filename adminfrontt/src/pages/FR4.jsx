...
const MyMap = () => {
  const laptopPositions = [
    { position: [31.5045342,74.3807674], text: 'R.A bazar' },
    { position: [31.4944416,74.3713491], text: 'Defence morr' },
    ...
    <div>
      ...
      <div className='card-inner'>
        <div className='card-heading'>
          <h3 className='cards-title'>FR 4</h3>
        ...
        <Table className='lgg' striped bordered hover variant='dark' size='sm'>
          ...
          <tbody>
            <tr>
              <td>{Routes[0].bus_number4}</td>
              <td>{Routes[0].All_stops4}</td>
              <td>{Routes[0].Route4}</td>
              <td>{Routes[0].Total_stops4}</td>
            </tr>
          </tbody>
        </Table>
      </div>
